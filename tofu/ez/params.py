...
MAP_TABLE = [
    ...
    ## Advanced Settings
    ['advanced_advtofu_lamino_angle','sections','cone-beam-weight','axis-angle-x'],           #SECTIONS['cone-beam-weight']['axis-angle-x'] str -> tupleize(dtype=list) (str?)
    ...
    ['advanced_advtofu_center_position_z','sections','cone-beam-weight','center-position-z'], #SECTIONS['cone-beam-weight']['center-position-z'] str -> (N/A) (in 'z-parameter'?)
